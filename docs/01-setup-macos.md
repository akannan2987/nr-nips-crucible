...
>
> A **repository** (or **repo**) ([glossary](00-glossary.md#the-git-words)) is a
...
> **[docs/07-operations.md](07-operations.md)** — this document is the fastest safe path
> on a Mac.
...
**image** ([glossary](00-glossary.md#the-container-words)) — the recipe (and packed
...
**container runtime** ([glossary](00-glossary.md#the-container-words)) — the program
...
- **podman machine** ([glossary](00-glossary.md#the-container-words)) — containers
...
- **port** ([glossary](00-glossary.md#the-web-and-api-words)) — one of your
...
- **localhost** ([glossary](00-glossary.md#the-web-and-api-words)) — `127.0.0.1`,
...
- **`curl`** ([glossary](00-glossary.md#the-web-and-api-words)) — a browser with no
...
([glossary](00-glossary.md#the-container-words)) job — cron is your Mac's kitchen
...
- **SQLite** ([glossary](00-glossary.md#the-data-words)) — a **database**
  ([glossary](00-glossary.md#the-data-words)) that lives in a single ordinary file
...
- **bind mount** ([glossary](00-glossary.md#the-container-words)) — a shared
...
So far the app speaks **HTTP** ([glossary](00-glossary.md#the-web-and-api-words)) —
...
- **TLS/SSL certificate** ([glossary](00-glossary.md#the-web-and-api-words)) — a
...
- **private key** ([glossary](00-glossary.md#the-web-and-api-words)) — the secret
  ...
  never committed.
- **self-signed certificate** ([glossary](00-glossary.md#the-web-and-api-words)) —
...
([glossary](00-glossary.md#the-web-and-api-words)) — a middleman server your
...
>
> (**.gitignore** ([glossary](00-glossary.md#the-git-words)) is a list of files Git
...
[01-setup-rhel8.md](01-setup-rhel8.md#5-verification-checklist).
...
([glossary](00-glossary.md#the-container-words)) — a small self-test the runtime
...
- **virtual environment (venv)** ([glossary](00-glossary.md#the-python-and-testing-words)) —
...
**Next:** [Uninstall guide](01-uninstall-macos.md) — how to cleanly remove
