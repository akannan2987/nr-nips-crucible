...
**Prerequisites:** a Mac with Crucible installed, and about 10 minutes. If you followed the [install guide](01-setup-macos.md), you are ready.
...
> assumes you have met a few of them in the [install guide](01-setup-macos.md).
>
...
[macOS Install & Run](01-setup-macos.md) · [RHEL8 Uninstall](01-uninstall-rhel8.md).
...
([glossary](00-glossary.md#the-container-words)) — the sealed lunchbox the app runs
in — and the **image** ([glossary](00-glossary.md#the-container-words)) it was built
from can both be rebuilt from the source code in ten minutes. The source code
itself is a **clone** ([glossary](00-glossary.md#the-git-words)) of a public
...
This single file *is* the **database** ([glossary](00-glossary.md#the-data-words)) —
the filing cabinet holding every chemical, sample, screening result, and
toxicology record you have entered. **SQLite**
([glossary](00-glossary.md#the-data-words)) keeps a whole database in one ordinary
...
The **TLS/SSL certificate** ([glossary](00-glossary.md#the-web-and-api-words)) is
the server's public ID card; the **private key**
([glossary](00-glossary.md#the-web-and-api-words)) is the secret half that proves
the card is yours. A **self-signed**
([glossary](00-glossary.md#the-web-and-api-words)) development pair — one you
...
- **Cron entries** — **cron** ([glossary](00-glossary.md#the-container-words)) is
...
- **`node_modules`, `dist`, `.venv`, caches** — downloaded libraries and build
  ...
  ([glossary](00-glossary.md#the-container-words)), the project's private Python
  sandbox.
...
(**podman machine**, [glossary](00-glossary.md#the-container-words)) that hosted
...
- `lsof -i :49160` asks who is holding **port**
  ([glossary](00-glossary.md#the-web-and-api-words)) 49160 — the numbered door
...
[01-setup-macos.md §3, Option B](01-setup-macos.md#3-enable-https).

Full instructions: [01-setup-macos.md](01-setup-macos.md).
...
**Next:** [Install guide](01-setup-macos.md) — start over from a clean Mac, now
