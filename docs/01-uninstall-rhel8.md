...
Companion documents: [RHEL8 Install & Run](01-setup-rhel8.md) ·
[macOS Uninstall](01-uninstall-macos.md).
...
> ([glossary](00-glossary.md#the-container-words)) — except the one in section 1
...
1. **Your data.** The SQLite database ([glossary](00-glossary.md#the-data-words))
...
**systemd user unit** ([glossary](00-glossary.md#the-container-words)) — a recipe
...
**Quadlet file** ([glossary](00-glossary.md#the-container-words)) — the newer,
...
- **Cron entries** ([glossary](00-glossary.md#the-container-words)) — the alarm
...
> [01-setup-rhel8.md §3](01-setup-rhel8.md#3-https-with-corporate-certificates)).
>
> Which is the whole reason `certs/` can be deleted without ceremony: the
> certificate ([glossary](00-glossary.md#the-web-and-api-words)) and its private
...
**Podman volume** ([glossary](00-glossary.md#the-container-words)) — a storage
...
**Podman network** ([glossary](00-glossary.md#the-container-words)) — a private
...
**Firewall rule** ([glossary](00-glossary.md#the-container-words)) — one
...
[01-setup-rhel8.md §1](01-setup-rhel8.md#1-prerequisites-one-time-vm-setup): the
...
**Lingering** ([glossary](00-glossary.md#the-container-words)) — permission for
...
| **R6** | **Re-enable lingering** — section 4.3 turned it off | [INSTALL §1.3](01-setup-rhel8.md#13-lingering) |
| **R7** | Re-create the systemd user unit | [INSTALL §4.2](01-setup-rhel8.md#42-generate-and-enable-the-unit) |
| **R8** | Re-create **both** cron jobs — health monitor *and* cert-expiry | [INSTALL §4.3](01-setup-rhel8.md#43-health-monitoring) · [§3.4](01-setup-rhel8.md#34-switching-modes-and-keeping-an-eye-on-expiry) |
| **R9** | Walk the V1–V9 checklist, ending with a real reboot | [INSTALL §5](01-setup-rhel8.md#5-verification-checklist) |
...
([INSTALL §1.4](01-setup-rhel8.md#14-firewall)). If `firewall-cmd` was not
...
# app comes up HTTP with no certificates (see 01-setup-rhel8.md §3):
cat > .env.local <<'EOF'
CERT_SOURCE=<cert-store-path>
CERT_HOSTNAME=<vm-hostname>
USE_HTTPS=true
...
[01-setup-rhel8 §3.2](01-setup-rhel8.md#32-configure-the-certificate-source);
...
[INSTALL §1.3](01-setup-rhel8.md#13-lingering).
...
[INSTALL §4.2](01-setup-rhel8.md#42-generate-and-enable-the-unit).
...
Details: [INSTALL §4.3](01-setup-rhel8.md#43-health-monitoring) (monitor) and
[INSTALL §3.4](01-setup-rhel8.md#34-switching-modes-and-keeping-an-eye-on-expiry)
(expiry).

### R9. Verify — V1 through V9

Run the full [V1–V9 checklist](01-setup-rhel8.md#5-verification-checklist). A
...
**Next:** [RHEL8 install guide](01-setup-rhel8.md) — the full production setup, from packages to reboot survival.
