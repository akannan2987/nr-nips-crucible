...
| SH | Phases 00–05b: the Python backend, PostgreSQL option, public-repository hygiene, platform verification, the document set, reproducible builds and CI; SH-1 module names ✅ (2026-09-08); **SH-12 the beta instance ✅ (2026-09-21, v2.20.0; live on the server 2026-09-22)** — the scripts know their instance, the workflow has two moments; **SH-13 the instance label ✅ (2026-09-22, v2.21.0)**; **SH-3a the token gate ✅ (2026-09-22, v2.22.0)** — one shared token closes an instance's port; on beta and on production the same day, each with its own token | **SH-3b · local accounts**, one login per tester on the beta instance, promoted after the testers have used it — the owner's priority of 2026-09-21 for user testing ([`13-authentication.md`](13-authentication.md)); SH-3c single sign-on on hold (not needed for the moment, the owner, 2026-09-22); **SH-2 · Schema normalisation** after | ✅ SH-3a v2.22.0 · 🔜 SH-3b **next** · ⏸ SH-3c · 🔜 SH-2 |
...
| **SH-3b** | **Local accounts** — usernames, Argon2-hashed passwords, a signed session cookie, three roles, `manage_users.py`; **in full** (A3 revisited 2026-09-21: testers need per-person logins and the registration has not arrived) | Gives *who*, which unlocks the audit trail and per-person revocation; one login per tester | ~~SH-3a~~ ✅ v2.22.0; on beta; promoted to production after the test | 🔜 **next** |
...
flowchart LR
    ...
    SD1s -.-> SH12["SH-12 beta instance ✅<br/>v2.20.0"] --> SH3a["SH-3a token gate ✅<br/>v2.22.0"] --> SH3b["SH-3b local accounts<br/>on beta first"] --> SH3c["SH-3c single sign-on<br/>on hold: not needed for now"]
```
