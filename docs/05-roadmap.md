...
|---|---|---|---|
| CR | Registry CRUD and uploads (CSV, TSV, XLSX, SDF, JSON); one import module for every route, import/export scripts and shortcuts (CR-3 ✅ 2026-09-09); the three real sources as template specs (CR-9 ✅ 2026-09-09); three views, sort and per-column filters (CR-1 + CR-2 ✅ 2026-09-09); the attention page — every flag in the browser with merge, keep both, mark reviewed, set the identifier (CR-10 ✅ 2026-09-09); the counts strip and the source tags (CR-11 ✅ 2026-09-14); PubChem linking and enrichment scripts; audit, merge and removal scripts, now callers of the same modules as the browser; R-1 and R-2 done: the registry is empty by design (2026-09-08); CR-6 deletion refuses or forces ✅ (2026-09-09) | **CR-12 · structures** (derive, draw, edit), in three releases — after the beta instance and the login (SH-12, SH-3a/b: the owner's priority of 2026-09-21); then the SD-1 build | ✅ CR-11 v2.18.0 · 📝 CR-12 specified, queued behind SH-12 and SH-3 |
...
| **SH-3b** | **Local accounts** — usernames, Argon2-hashed passwords, a signed sliding session cookie, three roles enforced by one rule, personal tokens for scripts, `manage_users.py` behind `./container-py.sh users`, a change-password dialog, a lockout; **in full** (A3 revisited 2026-09-21: testers need per-person logins and the registration has not arrived) | Gives *who*, which unlocks the audit trail and per-person revocation; one login per tester | ~~SH-3a~~ ✅ v2.22.0; on beta; promoted to production after the test | ✅ v2.23.0 (2026-09-22), on beta first — [phase SH-3b](04-phase-tutorials/phase-sh-3b-local-accounts.md); production's accounts created 2026-09-23, its switch at an announced moment (Step 10, v2.23.3) |
