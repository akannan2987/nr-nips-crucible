...
|---|---|---|---|
| CR | Registry CRUD and uploads (CSV, TSV, XLSX, SDF, JSON); one import module for every route, import/export scripts and shortcuts (CR-3 ✅ 2026-09-09); the three real sources as template specs (CR-9 ✅ 2026-09-09); three views, sort and per-column filters (CR-1 + CR-2 ✅ 2026-09-09); the attention page — every flag in the browser with merge, keep both, mark reviewed, set the identifier (CR-10 ✅ 2026-09-09); the counts strip and the source tags (CR-11 ✅ 2026-09-14); one checked structure per entry, derived from what the source gave, the disagreements on the attention page (CR-12 step A ✅ 2026-09-23); PubChem linking and enrichment scripts; audit, merge and removal scripts, now callers of the same modules as the browser; R-1 and R-2 done: the registry is empty by design (2026-09-08); CR-6 deletion refuses or forces ✅ (2026-09-09) | **CR-12 · structures**: ~~A derive and check~~ ✅ v2.24.0; **B draw** (the server-drawn picture in the detail view, the chooser dialogs and a thumbnail column) and **C edit** (the editor, a save checked by RDKit, the history kept) next; then the SD-1 build | ✅ CR-11 v2.18.0 · 🔨 CR-12 A ✅ v2.24.0, B and C next |
