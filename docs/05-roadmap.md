...
**2026-09-22:** SH-3a shipped (v2.22.0), the token gate, on beta first. The
owner decided that single sign-on is not needed for the moment, so SH-3c is
