...
> **New here?** [The Playbook](10-user-playbook.md) Part 7 introduces the query
...
**JSON** ([glossary](00-glossary.md#the-data-words)) — a way of writing structured
...
rule](02-architecture.md#the-one-design-rule-everything-else-follows-from)). The
...
> Security](07-operations.md#security)). Anyone who can reach port 49160 can run
...
[export endpoint](08-api-cookbook.md#downloading-a-selection) has no such cap.
