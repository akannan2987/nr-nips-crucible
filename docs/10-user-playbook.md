...
a small change — see
[Architecture](02-architecture.md) — but it is a developer task, not a
...
Recipes and a troubleshooting section: [Query Cookbook](09-query-cookbook.md).
...
The reference version of all this: [GitOps Workflow](03-git-workflow.md).
...
| Question | Guide |
|---|---|
| What does this word mean? | [Glossary](00-glossary.md) |
| How do I install or remove it? | [macOS](01-setup-macos.md) · [RHEL8](01-setup-rhel8.md) · [Uninstall](01-uninstall-rhel8.md) |
| How does identification decide? | [Chemical Identification](09-chemical-identification.md) |
| How do I write a query? | [Query Cookbook](09-query-cookbook.md) |
| How do I call the API? | [API Cookbook](08-api-cookbook.md) |
| How is it built, and why? | [Architecture](02-architecture.md) |
| How do I publish a change? | [GitOps Workflow](03-git-workflow.md) |
| What broke before, and what was learned? | [Lessons learned](11-lessons-learned.md) |
