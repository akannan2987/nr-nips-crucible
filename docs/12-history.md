...
# History — the Node/Express → Python/FastAPI migration
...
> See **[docs/07-operations.md](07-operations.md)** — runbooks (macOS Docker/Podman,
...
See [docs/07-operations.md → Backup and restore](07-operations.md#backup-and-restore).
...
- **PostgreSQL + Alembic** — ✅ delivered. Run `./container-py.sh db-start`
  ...
  (see [docs/07-operations.md → Database](07-operations.md#database-sqlite-and-postgresql)).
