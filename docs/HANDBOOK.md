...
| | |
|---|---|
| **Version** | 2.10.3 (2026-09-08); **the first tagged release is `v2.10.1`**, on both repositories, each tag on its own repository's commit |
