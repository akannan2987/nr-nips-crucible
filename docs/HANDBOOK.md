...
| | |
|---|---|
| **Version** | 2.20.2 (2026-09-22, the beta instance live on the server, two small script fixes; 2.20.0 and 2.20.1 the day before: the beta instance built, the promotion command corrected); the first tagged release was `v2.10.1` |
