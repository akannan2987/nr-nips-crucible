...
folder's settings file, off by default, on the beta instance first. Who is
...
4. ~~SH-12 the beta instance~~ done, v2.20.0, and live on the server since
   ...
   ~~SH-3a the token gate~~ done, v2.22.0, on beta first. **SH-3b local
