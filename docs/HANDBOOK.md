...
| 2026-09-23 | **v2.24.0.** CR-12 step A: one checked structure per compound, derived by RDKit from what the source gave and stored beside the laboratory's values; four checks (formula against every fragment, weight against both masses, the InChI by layer, unreadable sources); a fifth kind on the attention page; endpoint, script and button on one module. 446 findings on the real export. |
...
5. ~~CR-11~~ done, v2.18.0. **CR-12** — the owner's request of 2026-09-14:
   ...
   ~~A derive and check~~ done, v2.24.0 (2026-09-23; [phase CR-12](04-phase-tutorials/phase-cr-12-structures.md));
   **B draw** (the server-drawn picture) and **C edit** (the editor) next
   ([the reference](09-structures.md)).
