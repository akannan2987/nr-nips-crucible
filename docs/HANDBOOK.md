...
4. ~~SH-12 the beta instance~~ done, v2.20.0, and live on the server since
   ...
   roles; production's accounts created 2026-09-23, its switch to accounts at
   a moment the owner announces ([Step 10, in two moments](04-phase-tutorials/phase-sh-3b-local-accounts.md#step-10--production-in-two-moments-the-accounts-then-the-switch));
