...
2. ~~SD-1 agreed~~ 2026-09-08, **then R-2:** the registry-first rule is
   ...
   demo).
3. ~~CR-6~~ done, v2.11.0. **CR-3 — every way in:** JSON upload and one terminal command, so the
