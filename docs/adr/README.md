...
| # | Decision | Status |
|---|---|---|
| [0001](0001-authentication-ladder.md) | Authentication is added as a ladder — token gate, local accounts, single sign-on — behind one feature flag, with single sign-on as the destination | accepted; rung 1 built (v2.22.0, SH-3a) and rung 2 built (v2.23.0, SH-3b); rung 3 on hold at the owner's request (2026-09-22) |
